...
use \Elementor\Widget_TommusRhodus_Image_Collage_Block as Widget_TommusRhodus_Image_Collage_Block;
use \Elementor\Plugin as Plugin;


class SPG_Widget_TommusRhodus_Image_Collage_Block extends Widget_TommusRhodus_Image_Collage_Block
{
			...
			<div class="image-collage">
				...
				<a href="'. esc_url( $url[0] ) .'" data-fancybox="Collage Gallery" class="d-none d-lg-block">
					<div data-jarallax-element="0 12">
						'. wp_get_attachment_image( $settings['image']['id'],$img_size, 0, array( 'class' => 'rounded', 'data-aos' => 'fade-right' ) ) .'
					</div>
				</a>
				
				<a href="'. esc_url( $url2[0] ) .'" data-fancybox="Collage Gallery">
					<div>
						'. wp_get_attachment_image( $settings['image2']['id'], $img_size, 0, array( 'class' => 'rounded', 'data-aos' => 'fade-up' ) ) .'
					</div>
				</a>
				
				<a href="'. esc_url( $url3[0] ) .'" data-fancybox="Collage Gallery" class="d-none d-lg-block">
					<div data-jarallax-element="0 -12">
						'. wp_get_attachment_image( $settings['image3']['id'], $img_size, 0, array( 'class' => 'rounded', 'data-aos' => 'fade-left' ) ) .'
					</div>
				</a>
...
Plugin::instance()->widgets_manager->register_widget_type( new SPG_Widget_TommusRhodus_Image_Collage_Block() );