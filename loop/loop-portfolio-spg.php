			...
			<a href="<?php the_permalink(); ?>">
                    <div class="rounded is-shadow-box d-flex align-items-end project-card" style= 'background-image: url("<?php echo get_the_post_thumbnail_url() ?>")'>
                        <div class="project-card-label">
				            <div class="text-small text-muted px-4 project-card-label__term"><?php echo esc_attr( TommusRhodus_Framework()->the_terms( $post->ID, 'portfolio_category', 'name', ' | ', false, true ) ); ?></div>
                            <div class="p-2 text-light project-card-label__title">
