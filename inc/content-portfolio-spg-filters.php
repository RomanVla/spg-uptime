...
<div class="row justify-content-center mb-4">
    <div class="col col-md-auto dropdown project-card-filter">
        <div class="btn-group">
            <button class="btn btn-primary project-card-filter__title"> Choose project area or technology </button>
            <button class="btn btn-primary dropdown-toggle dropdown-toggle-split" type="button" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-reference="parent">
