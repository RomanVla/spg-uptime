    ...
    <div class="container">
        ...
        <div class="row mb-2">
            ...
            if (is_active_sidebar('default_footer_2') && !(is_active_sidebar('default_footer_3'))) {
                echo '<div class="col-md-6 col-lg-6 col-sm-12 col-12 py-2">';
                    echo '<div class="widget">';
                        echo get_custom_logo('');
                    echo '</div>';
                    dynamic_sidebar('default_footer_1');
                echo '</div><div class="col-md-6 col-lg-6 col-sm-12 col-12 py-2">';
                    dynamic_sidebar('default_footer_2');
                echo '</div><div class="clear"></div>';
            }
            if (is_active_sidebar('default_footer_3')) {
                echo '<div class="col-md-3 col-lg-3 col-sm-12 col-12 py-2">';
                    echo get_custom_logo();
                    dynamic_sidebar('default_footer_1');
                echo '</div><div class="col-md-6 col-lg-6 col-sm-12 col-12 py-2">';
                    dynamic_sidebar('default_footer_2');
                echo '</div><div class="col-md-3 col-lg-3 col-sm-12 col-12 py-2">';
